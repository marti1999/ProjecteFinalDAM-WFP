...
namespace desktopapplication.Model
{
    class RewardRepository
    {
        ...
        {
            Reward r = (Reward)MakeRequestUpdate(string.Concat(Utils.ws, "reward/update/" + id), re, "PUT", "application/json", typeof(Reward));
            return r;
        }
        ...
        public static object MakeRequestUpdate(string requestUrl, object JSONRequest, string JSONmethod, string JSONContentType, Type JSONResponseType)
        //  requestUrl: Url completa del Web Service, amb l'opció sol·licitada
        //  JSONrequest: objecte que se li passa en el body (només per a POST/PUT)
        //  JSONmethod: "GET"/"POST"/"PUT"/"DELETE"
        //  JSONContentType: "application/json" en els casos que el Web Service torni objectes
        //  JSONRensponseType:  tipus d'objecte que torna el Web Service (typeof(tipus))
        {
            ...
            {
                MessageBox.Show("Can't be edited, because it has been claimed");
                return null;
            }
        }
    }
